...
const SearchBar = () => {
  ...
  return (
    <div className={` relative ${isFocused?"ring-1 border-blue-500 outline-none":""} flex items-center pl-2 overflow-hidden gap-2 bg-white/10 w-[40%] rounded-full h-[100%] sm:h-[90%] `}>
